package org.intelehealth.abdm.abha_verify;

import static org.intelehealth.abdm.constants.AbdmConstant.AADHAAR_CARD_SELECTION;
...
import static org.intelehealth.abdm.constants.AbdmConstant.SCOPE_INDEX;
...
public class AbhaCardVerificationActivity extends AppCompatActivity {
            ...
            if (checkValidation()) {
                ...
                if (binding.sendOtpBtn.getTag() == null) {  // ie. fresh call - sending otp.
                    ...
                    if (Objects.requireNonNull(binding.otpBox.getText()).toString().isEmpty()) {    // ie. OTP not entered in box.
                        snackbarUtils.showSnackLinearLayoutParentSuccess(context, binding.llActionBar, getString(R.string.please_enter_otp_received), false);
                        return;
                    }
    ...
    private void setAbhaCardVisibility() {
        ...
        AbdmManager.setAbhaLoginType(AbdmConstant.ABHA_LOGIN);
        ...
        binding.layoutHaveABHANumber.buttonAbhaNumber.setBackgroundResource(R.drawable.bg_btn_abha_option);
        binding.layoutHaveABHANumber.buttonUsername.setBackgroundResource(R.drawable.bg_btn_abha_option_disabled);
        binding.layoutHaveABHANumber.buttonMobileNumber.setBackgroundResource(R.drawable.bg_btn_abha_option_disabled);
        binding.sendOtpBtn.setText(R.string.send_otp);
    ...
    private void setMobileVisibility() {
        ...
        AbdmManager.setAbhaLoginType(AbdmConstant.MOBILE_LOGIN);
        binding.layoutHaveABHANumber.cvTermsAndCondition.setVisibility(View.GONE);
        ...
        binding.layoutHaveABHANumber.buttonMobileNumber.setBackgroundResource(R.drawable.bg_btn_abha_option);
        binding.layoutHaveABHANumber.buttonUsername.setBackgroundResource(R.drawable.bg_btn_abha_option_disabled);
        binding.layoutHaveABHANumber.buttonAbhaNumber.setBackgroundResource(R.drawable.bg_btn_abha_option_disabled);
        binding.layoutHaveABHANumber.edittextMobileNumber.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_input_field_new));
        binding.layoutHaveABHANumber.edittextUsername.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_input_field_new));
    ...
    private void setAadhaarCardVisibility() {
        ...
        AbdmManager.setAbhaLoginType(AbdmConstant.AADHAAR_LOGIN);
        ...
        binding.layoutHaveABHANumber.tvUsernameError.setVisibility(View.GONE);
        binding.layoutHaveABHANumber.flAbhaDetails.setVisibility(View.GONE);
        binding.layoutHaveABHANumber.buttonUsername.setBackgroundResource(R.drawable.bg_btn_abha_option);
        binding.layoutHaveABHANumber.buttonMobileNumber.setBackgroundResource(R.drawable.bg_btn_abha_option_disabled);
        binding.layoutHaveABHANumber.buttonAbhaNumber.setBackgroundResource(R.drawable.bg_btn_abha_option_disabled);
        binding.layoutHaveABHANumber.edittextMobileNumber.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_input_field_new));
        binding.layoutHaveABHANumber.edittextUsername.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_input_field_new));
    ...
    private MobileLoginApiBody getSendOtpApiRequest() {
        ...
        switch (optionSelected) {
            ...
            case ABHA_SELECTION -> {
                String value = TextUtils.isEmpty(binding.layoutHaveABHANumber.abhaDetails.etAbhaNumber.getText()) ? Objects.requireNonNull(binding.layoutHaveABHANumber.abhaDetails.etAbhaAddress.getText()).toString().trim() : AbdmUtils.formatIntoAbhaString(binding.layoutHaveABHANumber.abhaDetails.etAbhaNumber.getText().toString().trim());
    ...
    private void searchMobile(String accessToken, SearchAbhaProfile requestBody) {  // mobile: Step 2
        ...
        if (isAbhaProfileSelected && apiBody != null) {
            ...
            Single<Response<HashMap<String, SearchAbhaProfileResponse>>> mobileResponseSingle = RetrofitProvider.getApiService().searchAbhaProfile(accessToken, requestBody);
            new Thread(() -> {
                // api - start
    ...
    private void sentOtpApi(String accessToken, MobileLoginApiBody requestBody) {  // mobile: Step 2
        cpd.show(getString(R.string.otp_sending));
        AbdmManager.setTempScope(requestBody.getScope());

        Single<Response<OTPResponse>> mobileResponseSingle = RetrofitProvider.getApiService().getOtpForMobile(accessToken, requestBody);
        mobileResponseSingle
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new DisposableSingleObserver<>() {
                    ...
                    public void onSuccess(Response<OTPResponse> otpResponse) {
                        ...
                        if (otpResponse.code() == 200) {
                            ...
                            setOtpVisibility();
                            snackbarUtils.showSnackLinearLayoutParentSuccess(context, binding.llActionBar, otpResponse.body().getMessage(), true);
    ...
    private void callOTPForABHALoginVerificationApi(String txnId, String otp) {
        ...
        Single<Response<MobileLoginOnOTPVerifiedResponse>> mobileLoginOnOTPVerifiedResponseSingle = RetrofitProvider.getApiService().getOtpForMobileLoginVerification(
                accessToken,
                requestBody
        );
                    ...
                    public void onSuccess(Response<MobileLoginOnOTPVerifiedResponse> response) {
                        ...
                        if (response.code() == 200) {
                            if (response.body() != null) {
                                MobileLoginOnOTPVerifiedResponse mobileLoginOnOTPVerifiedResponse = response.body();
                                Timber.tag("callOTPForMobileLoginVerificationApi").d("onSuccess: %s", mobileLoginOnOTPVerifiedResponse.toString());
                                if (mobileLoginOnOTPVerifiedResponse.getAccounts() != null && !mobileLoginOnOTPVerifiedResponse.getAccounts().isEmpty()) {
                                    String ABHA_NUMBER = mobileLoginOnOTPVerifiedResponse.getAccounts().get(0).getABHANumber();
                                    String X_TOKEN = BEARER_AUTH + mobileLoginOnOTPVerifiedResponse.getToken();
                                    callFetchUserProfileAPI(ABHA_NUMBER, mobileLoginOnOTPVerifiedResponse.getTxnId(), X_TOKEN);
                                    binding.sendOtpBtn.setTag(null);    // resetting...
    ...
    private void showOkDialog(String message, DialogUtils.CustomDialogListener customDialogListener) {
        DialogUtils.showOkDialog(AbhaCardVerificationActivity.this, AppCompatResources.getDrawable(AbhaCardVerificationActivity.this, R.drawable.ic_close_patient), getString(R.string.abha_user_not_found), message, getString(R.string.ok), customDialogListener);
    }
    ...
    private void callFetchAuthModesAPI(String abhaAddress, String xToken, String accessToken) {
        ...
        Single<Response<FetchAuthModesResponse>> fetchAuthModesResponse = RetrofitProvider.getApiService().fetchAuthModes(requestBody, accessToken, xToken);
    ...
    private void callFetchUserProfileAPI(String abhaNumber, String txnId, String xToken) {
        ...
        Single<AbhaProfileResponse> abhaProfileResponseSingle = RetrofitProvider.getApiService().pushAbhaProfile(accessToken, xToken, requestBody);
    ...
    private void checkIsUserExist(String abhaNumber, AbhaProfileResponse abhaProfileResponse, String xToken, AbhaProfileRequestBody abhaProfileRequestBody) {
        String encoded = AbdmManager.getEncoded();
        String url = AbdmManager.getCheckExistingUserUrl();
        cpd.show();
        // payload - end
        Single<ExistUserStatusResponse> abhaProfileResponseSingle = RetrofitProvider.getApiService().checkExistingUser(
                url + abhaNumber,
                "Basic " + encoded
        );
                ...
                .subscribe(new DisposableSingleObserver<>() {
                    ...
                    public void onSuccess(ExistUserStatusResponse response) {
                        ...
                        if (responseData.getUuid().equalsIgnoreCase("NA")) { // NA response indicates that the patient isn't present on our local db.
                            navigateToIdentificationScreenWithNewPatient(abhaProfileResponse, xToken, abhaProfileRequestBody);
                            return;
                        }
    ...
    private boolean areInputFieldsValid_HasABHA() {
        ...
        if (!optionSelected.isEmpty() && optionSelected.equals(AADHAAR_CARD_SELECTION)) {
            ...
            if (aadhaarNo.isEmpty()) {
                ...
                binding.layoutHaveABHANumber.edittextUsername.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_input_field_error));
                isValid = false;
            } else {
            ...
            if (mobile.isEmpty()) {
                ...
                binding.layoutHaveABHANumber.edittextMobileNumber.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_input_field_error));
                isValid = false;
            } else {
