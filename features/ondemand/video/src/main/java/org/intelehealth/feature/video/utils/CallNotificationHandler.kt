package org.intelehealth.feature.video.utils
...
import org.intelehealth.feature.video.utils.CallConstants.ACTION_ACCEPT
import org.intelehealth.feature.video.utils.CallConstants.ACTION_DECLINE
import org.intelehealth.feature.video.utils.CallConstants.ACTION_HANG_UP
import org.intelehealth.feature.video.utils.CallConstants.MAX_INT
...
object CallNotificationHandler {
    ...
    fun outGoingCallNotificationBuilder(
        ...
        return NotificationCompat.Builder(context, getChannelId(context))
            ...
            .setColor(ContextCompat.getColor(context, org.intelehealth.resources.R.color.blue_1))
...
//            }
    ...
    private fun buildMissedCallNotification(
        ...
        return NotificationCompat.Builder(context, getChannelId(context))
            ...
            .setColor(ContextCompat.getColor(context, org.intelehealth.resources.R.color.red))
            .setSmallIcon(messageBody.notificationIcon)
