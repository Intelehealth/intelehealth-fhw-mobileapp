...
import static org.intelehealth.core.utils.utility.CoreConstantsKt.RTC_ARGS;
...
import org.intelehealth.app.feature.video.ui.custom.SwipeButton;
...
import org.intelehealth.app.feature.video.databinding.ActivityVideoCallBinding;
import org.intelehealth.app.feature.video.model.CallArgs;
import org.intelehealth.app.feature.video.utils.CallMode;
import org.intelehealth.app.feature.video.utils.CallType;
...
public class IDAVideoActivity extends CoreVideoCallActivity implements SwipeButton.SwipeEventListener {
    public static void startVideoCallActivity(Context context, CallArgs args) {
        ...
        intent.putExtra(RTC_ARGS, args);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        }
        int callState = ((TelephonyManager) context.getSystemService(TELEPHONY_SERVICE)).getCallState();
