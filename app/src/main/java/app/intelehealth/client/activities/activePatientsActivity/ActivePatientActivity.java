           ...
           /* recyclerView.addItemDecoration(new
            ...
            mActivePatientAdapter.setActionListener(new ActivePatientAdapter.OnActionListener() {
                ...
                public void onEndVisitClicked(ActivePatientModel activePatientModel, boolean hasPrescription) {
                    ...
                    Intent visitSummary = new Intent(ActivePatientActivity.this, VisitSummaryActivity.class);

                    visitSummary.putExtra("visitUuid", visitUuid);
                    visitSummary.putExtra("patientUuid", activePatientModel.getPatientuuid());
                    ...
                    visitSummary.putExtra("name", String.format("%s %s", activePatientModel.getFirst_name(), activePatientModel.getLast_name()));
                    visitSummary.putExtra("gender", activePatientModel.getGender());
                    visitSummary.putExtra("float_ageYear_Month", DateAndTimeUtils.getFloat_Age_Year_Month(activePatientModel.getDate_of_birth()));
                    visitSummary.putExtra("tag", "");
                    boolean past_visit = activePatientModel.getEnddate() != null;
