package io.intelehealth.client.backup;
...
//        mBuilder = new NotificationCompat.Builder(context, channelId);
    ...
    public void startCloudBackup(@Nullable Integer queue_id, Boolean is_auto) {
        ...
        location = sessionManager.getLocationName();
        user_id = sessionManager.getCreatorID();
...
//            }
        ...
        Logger.logD("newfilepath", AppConstants.dbfilepath);
        File myfile = new File(AppConstants.dbfilepath);
        if (myfile.exists()) {
...
//        }
    ...
    public void startCloudRestore() {
        ...
        location = sessionManager.getLocationName();
        user_id = sessionManager.getCreatorID();
        File local_backup = new File(AppConstants.dbfilepath);
