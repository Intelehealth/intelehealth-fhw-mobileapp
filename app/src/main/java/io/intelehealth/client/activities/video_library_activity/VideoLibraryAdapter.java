package io.intelehealth.client.activities.video_library_activity;
...
public class VideoLibraryAdapter extends RecyclerView.Adapter<VideoLibraryAdapter.VideoLibraryHolder> {
    ...
    public static class VideoLibraryHolder extends RecyclerView.ViewHolder {
        ...
        public VideoLibraryHolder(View itemView) {
            super(itemView);
            rootView = itemView;
            image = (ImageView) itemView.findViewById(R.id.video_thumbnail_ImageView);
            text = (TextView) itemView.findViewById(R.id.video_name_TextView);
        }
