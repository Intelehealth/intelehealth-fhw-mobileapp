package org.intelehealth.svhmhelpline.knowledgeEngine;
...
import org.intelehealth.svhmhelpline.utilities.InputFilterMinMax;
...
import org.intelehealth.svhmhelpline.activities.complaintNodeActivity.CustomArrayAdapter;
    ...
    public static void subAskDuration(final Node node, Activity context, final CustomArrayAdapter adapter) {
        ...
        durationDialog.setPositiveButton(R.string.generic_ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                unit_text = kn_en(unit_text); //for Hindi...
                unit_text = mr_en(unit_text); //for Marathi...
                unit_text = or_en(unit_text); //for Odia...
                unit_text = gu_en(unit_text); //for Gujarati...
