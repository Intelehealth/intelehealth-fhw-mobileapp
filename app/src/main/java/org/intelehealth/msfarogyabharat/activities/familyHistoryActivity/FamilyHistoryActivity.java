package org.intelehealth.msfarogyabharat.activities.familyHistoryActivity;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(org.intelehealth.msfarogyabharat.utilities.StringUtils.getValue(value));
