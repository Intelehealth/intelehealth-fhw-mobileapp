...
//            values.put("speciality_value", visitDTO.getValue());
            ...
            if(visitDTO.getVisit_attribute_type_uuid().equalsIgnoreCase(SPECIALITY) ||
                    visitDTO.getVisit_attribute_type_uuid().equalsIgnoreCase(HOSPITAL_TYPE))
            {
    ...
    public boolean insertVisitAttributes(String visitUuid, String value, String VISIT_TYPE_UUID) throws
            DAOException {
        ...
        try
        {
            ...
            values.put("visit_attribute_type_uuid", VISIT_TYPE_UUID);
            values.put("voided", "0");
            values.put("sync", "0");
