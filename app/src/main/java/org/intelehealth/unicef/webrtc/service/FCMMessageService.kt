package org.intelehealth.unicef.webrtc.service

import com.github.ajalt.timberkt.Timber
import com.google.firebase.messaging.RemoteMessage
import com.google.gson.Gson
import org.intelehealth.unicef.webrtc.receiver.FCMNotificationReceiver
...
class FCMMessageService : FBMessageService(FCMNotificationReceiver::class.java) {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        Timber.d { "Remote message ${Gson().toJson(message.data)}" }
    }
}
