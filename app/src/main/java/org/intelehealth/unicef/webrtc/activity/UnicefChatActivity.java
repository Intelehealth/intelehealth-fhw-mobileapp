 ...
 * Mob   : +919727206702
 **/
public class UnicefChatActivity extends ChatActivity {
    public static void startChatActivity(Context context, RtcArgs args) {
        Intent chatIntent = new Intent(context, UnicefChatActivity.class);
    ...
    protected void initiateView() {
        ...
        mLayoutManager = new LinearLayoutManager(UnicefChatActivity.this, LinearLayoutManager.VERTICAL, true);
