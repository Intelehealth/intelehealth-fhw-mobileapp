...
public class CallListenerBackgroundService extends Service {
    ...
    public void onDestroy() {
        ...
        intent.setAction("org.intelehealth.unicef.RTC_SERVICE_START");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://intelehealth-unicef-default-rtdb.asia-southeast1.firebasedatabase.app/");
        DatabaseReference myRef = database.getReference("rtc_notify/" + new SessionManager(this).getProviderID() + "/VIDEO_CALL");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                if (!isOldNotification) {
                    ...
                    intent.setAction("org.intelehealth.unicef.RTC_MESSAGE_EVENT");
                    sendBroadcast(intent);
                }
