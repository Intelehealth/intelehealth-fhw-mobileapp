...
/**
 * Created by Prajwal Maruti Waingankar on 23-12-2021, 11:43
 * Copyright (c) 2021 . All rights reserved.
 * Email: prajwalwaingankar@gmail.com
 * Github: prajwalmw
 */

public class MedicationPrescAdapter extends RecyclerView.Adapter<MedicationPrescAdapter.PrescViewModel> {
    Context context;
    List<PrescDataModel> prescDataModels;
    SessionManager sessionManager;
    Base64Utils base64Utils = new Base64Utils();

    public MedicationPrescAdapter(Context context, List<PrescDataModel> prescDataModels) {
        this.context = context;
        this.prescDataModels = prescDataModels;
        sessionManager = new SessionManager(this.context);
    }

    public MedicationPrescAdapter(Context presContext) {
