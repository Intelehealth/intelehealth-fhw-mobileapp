...
import org.intelehealth.unicef.activities.prescription.PrescriptionActivity;
                        ...
                        if (mAppointmentDetailsResponse.getData() == null) {
                            ...
                            try {
                                ...
                                mInfoAppointmentBookingTextView.setText(getString(R.string.appointment_booked) + ":\n\n" +
                                        org.intelehealth.unicef.utilities.StringUtils.getTranslatedDays(mAppointmentDetailsResponse.getData().getSlotDay(), new SessionManager(VisitSummaryActivity.this).getAppLanguage()) + "\n" +
