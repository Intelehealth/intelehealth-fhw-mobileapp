package org.intelehealth.unicef.activities.questionNodeActivity.adapters;
...
public class AssociatedSysAdapter extends RecyclerView.Adapter<AssociatedSysAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AssociatedSysAdapter.ItemViewHolder itemViewHolder, int position) {
        ...
        if (thisNode.isSelected() && thisNode.getAssociated_symptoms() == 1) {
            ...
            itemViewHolder.chip_yes.setBackground(ContextCompat.getDrawable(mContext, R.drawable.ui2_common_primary_bg));
            itemViewHolder.chip_No.setTextColor(ContextCompat.getColor(mContext, R.color.colorPrimary));
            itemViewHolder.chip_No.setBackground(ContextCompat.getDrawable(mContext, R.drawable.ui2_chip_type_1_bg));
            ...
            itemViewHolder.chip_No.setBackground(ContextCompat.getDrawable(mContext, R.drawable.ui2_common_primary_bg));
            itemViewHolder.chip_yes.setTextColor(ContextCompat.getColor(mContext, R.color.colorPrimary));
            itemViewHolder.chip_yes.setBackground(ContextCompat.getDrawable(mContext, R.drawable.ui2_chip_type_1_bg));
        } else {
            itemViewHolder.chip_No.setTextColor(ContextCompat.getColor(mContext, R.color.colorPrimary));
            itemViewHolder.chip_No.setBackground(ContextCompat.getDrawable(mContext, R.drawable.ui2_chip_type_1_bg));
            itemViewHolder.chip_yes.setTextColor(ContextCompat.getColor(mContext, R.color.colorPrimary));
