...
public class SetupPrivacyNoteActivity_New extends LocalConfigActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTermsAndPrivacy = findViewById(R.id.tvPrivacyNoticeLinkSetupScreen);
    ...
    public void termsAndPrivacyPolicy() {
        SpannableString SpanString = new SpannableString(getResources().getString(R.string.agree_to_terms_and_conditions_and_privacy_policy));
        ...
        int startingPositionTC = getResources().getString(R.string.agree_to_terms_and_conditions_and_privacy_policy).indexOf(getResources().getString(R.string.terms_and_conditions));
        int endingPositionTC = startingPositionTC + getResources().getString(R.string.terms_and_conditions).length();
        int startingPositionPP = getResources().getString(R.string.agree_to_terms_and_conditions_and_privacy_policy).indexOf(getResources().getString(R.string.privacy_policy));
