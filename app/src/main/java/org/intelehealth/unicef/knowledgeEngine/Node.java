package org.intelehealth.unicef.knowledgeEngine;
...
public class Node implements Serializable {
     ...
     * <p>
     * text - the text that is displayed on the unicef to user
     ...
     * should be stored in the physicalExamAssets folder within the unicef when compiling
    ...
    //Terminal nodes are important to identify to know so that the unicef does not keep looking for sub-nodes.
