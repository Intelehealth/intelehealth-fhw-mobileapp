package org.intelehealth.vikalphelpline.activities.familyHistoryActivity;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(org.intelehealth.vikalphelpline.utilities.StringUtils.getValue(value));
