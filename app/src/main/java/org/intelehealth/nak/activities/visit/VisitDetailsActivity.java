...
import static org.intelehealth.nak.database.dao.EncounterDAO.getChiefComplaint;
import static org.intelehealth.nak.database.dao.ObsDAO.fetchDrDetailsFromLocalDb;
import static org.intelehealth.nak.database.dao.ObsDAO.getFollowupDataForVisitUUID;
import static org.intelehealth.nak.database.dao.PatientsDAO.phoneNumber;
import static org.intelehealth.nak.database.dao.VisitAttributeListDAO.fetchSpecialityValue;
import static org.intelehealth.nak.database.dao.VisitsDAO.fetchVisitModifiedDateForPrescPending;
import static org.intelehealth.nak.database.dao.VisitsDAO.isVisitNotEnded;
import static org.intelehealth.nak.utilities.DateAndTimeUtils.timeAgoFormat;
...
import org.intelehealth.nak.models.PrescriptionModel;
                            ...
                            if (visitValue != null && !visitValue.isEmpty()) {
                                ...
                                if (needToShowCoreValue) {
                                    ...
                                    for (String s : spt) {
                                        ...
                                        if (!s.trim().contains(org.intelehealth.nak.ayu.visit.common.VisitUtils.getTranslatedPatientDenies(sessionManager.getAppLanguage()))) {
                                            list.add(s);
                                        }
