...
import org.intelehealth.nak.models.ActivePatientModel;
...
import org.intelehealth.nak.utilities.NotificationID;
import org.intelehealth.nak.utilities.PatientsFrameJson;
            ...
            public void onResponse(Call<ResponseDTO> call, Response<ResponseDTO> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (sync) {
                        ...
                        broadcast.setPackage(IntelehealthApplication.getInstance().getPackageName());
