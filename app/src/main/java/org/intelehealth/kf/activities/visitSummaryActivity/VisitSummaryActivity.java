package org.intelehealth.kf.activities.visitSummaryActivity;

import static org.intelehealth.kf.database.dao.EncounterDAO.getStartVisitNoteEncounterByVisitUUID;
import static org.intelehealth.kf.utilities.UuidDictionary.ENCOUNTER_ROLE;
import static org.intelehealth.kf.utilities.UuidDictionary.ENCOUNTER_VISIT_NOTE;
import static org.intelehealth.kf.utilities.UuidDictionary.PRESCRIPTION_LINK;
import static org.intelehealth.kf.utilities.UuidDictionary.SPECIALITY;
...
import org.intelehealth.kf.activities.additionalDocumentsActivity.AdditionalDocumentsActivity;
import org.intelehealth.kf.activities.complaintNodeActivity.ComplaintNodeActivity;
import org.intelehealth.kf.activities.familyHistoryActivity.FamilyHistoryActivity;
import org.intelehealth.kf.activities.homeActivity.HomeActivity;
import org.intelehealth.kf.activities.pastMedicalHistoryActivity.PastMedicalHistoryActivity;
import org.intelehealth.kf.activities.physcialExamActivity.PhysicalExamActivity;
import org.intelehealth.kf.activities.prescription.PrescriptionActivity;
...
import org.intelehealth.kf.appointment.ScheduleListingActivity;
import org.intelehealth.kf.appointment.api.ApiClientAppointment;
import org.intelehealth.kf.appointment.dao.AppointmentDAO;
import org.intelehealth.kf.appointment.model.AppointmentDetailsResponse;
import org.intelehealth.kf.appointment.model.CancelRequest;
import org.intelehealth.kf.appointment.model.CancelResponse;
import org.intelehealth.kf.database.dao.EncounterDAO;
import org.intelehealth.kf.database.dao.ImagesDAO;
import org.intelehealth.kf.database.dao.ObsDAO;
import org.intelehealth.kf.database.dao.PatientsDAO;
import org.intelehealth.kf.database.dao.ProviderAttributeLIstDAO;
import org.intelehealth.kf.database.dao.RTCConnectionDAO;
import org.intelehealth.kf.database.dao.SyncDAO;
import org.intelehealth.kf.database.dao.VisitAttributeListDAO;
import org.intelehealth.kf.database.dao.VisitsDAO;
import org.intelehealth.kf.knowledgeEngine.Node;
import org.intelehealth.kf.models.ClsDoctorDetails;
import org.intelehealth.kf.models.Patient;
import org.intelehealth.kf.models.dto.EncounterDTO;
import org.intelehealth.kf.models.dto.ObsDTO;
import org.intelehealth.kf.models.dto.RTCConnectionDTO;
import org.intelehealth.kf.models.prescriptionUpload.EncounterProvider;
import org.intelehealth.kf.models.prescriptionUpload.EndVisitEncounterPrescription;
import org.intelehealth.kf.models.prescriptionUpload.EndVisitResponseBody;
import org.intelehealth.kf.networkApiCalls.ApiClient;
import org.intelehealth.kf.networkApiCalls.ApiInterface;
import org.intelehealth.kf.services.DownloadService;
...
import org.intelehealth.kf.utilities.VisitUtils;
                    ...
                    try {
                        if (!isVisitSpecialityExists) {
                            isUpdateVisitDone = speciality_attributes
                                    .insertVisitAttributes(visitUuid, speciality_selected, SPECIALITY);
                        }
                        ...
                        if (mAppointmentDetailsResponse.getData() == null) {
                            ...
                            try {
                                ...
                                mInfoAppointmentBookingTextView.setText(getString(R.string.appointment_booked) + ":\n\n" +
                                        org.intelehealth.kf.utilities.StringUtils.getTranslatedDays(mAppointmentDetailsResponse.getData().getSlotDay(), new SessionManager(VisitSummaryActivity.this).getAppLanguage()) + "\n" +
