...
import static org.intelehealth.kf.database.dao.EncounterDAO.getChiefComplaint;
import static org.intelehealth.kf.database.dao.ObsDAO.fetchDrDetailsFromLocalDb;
import static org.intelehealth.kf.database.dao.ObsDAO.getFollowupDataForVisitUUID;
import static org.intelehealth.kf.database.dao.PatientsDAO.phoneNumber;
import static org.intelehealth.kf.database.dao.VisitAttributeListDAO.fetchSpecialityValue;
import static org.intelehealth.kf.database.dao.VisitsDAO.fetchVisitModifiedDateForPrescPending;
import static org.intelehealth.kf.database.dao.VisitsDAO.isVisitNotEnded;
import static org.intelehealth.kf.utilities.DateAndTimeUtils.timeAgoFormat;
                            ...
                            if (visitValue != null && !visitValue.isEmpty()) {
                                ...
                                if (needToShowCoreValue) {
                                    ...
                                    for (String s : spt) {
                                        ...
                                        if (!s.trim().contains(org.intelehealth.kf.ayu.visit.common.VisitUtils.getTranslatedPatientDenies(sessionManager.getAppLanguage()))) {
                                            list.add(s);
                                        }
