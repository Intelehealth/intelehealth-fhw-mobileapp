...
import static org.intelehealth.kf.database.dao.VisitsDAO.getPendingPrescCount;
...
import org.intelehealth.kf.utilities.VisitCountInterface;
...
public class VisitReceivedFragment extends Fragment {
    ...
    private void initUI(View view) {
        ...
        LinearLayoutManager reLayoutManager = new LinearLayoutManager(requireActivity().getApplicationContext());
