...
import static org.intelehealth.kf.ayu.visit.common.VisitUtils.convertCtoF;
import static org.intelehealth.kf.ayu.visit.common.VisitUtils.getTranslatedAssociatedSymptomQString;
import static org.intelehealth.kf.ayu.visit.common.VisitUtils.getTranslatedPatientDenies;
import static org.intelehealth.kf.database.dao.EncounterDAO.fetchEncounterUuidForEncounterAdultInitials;
import static org.intelehealth.kf.database.dao.EncounterDAO.fetchEncounterUuidForEncounterVitals;
import static org.intelehealth.kf.knowledgeEngine.Node.bullet_arrow;
import static org.intelehealth.kf.syncModule.SyncUtils.syncNow;
import static org.intelehealth.kf.ui2.utils.CheckInternetAvailability.isNetworkAvailable;
import static org.intelehealth.kf.utilities.DateAndTimeUtils.parse_DateToddMMyyyy;
import static org.intelehealth.kf.utilities.UuidDictionary.ADDITIONAL_NOTES;
...
import static org.intelehealth.kf.utilities.VisitUtils.endVisit;
...
import org.intelehealth.kf.activities.additionalDocumentsActivity.AdditionalDocumentAdapter;
...
import org.intelehealth.kf.activities.notification.AdapterInterface;
import org.intelehealth.kf.app.AppConstants;
import org.intelehealth.kf.app.IntelehealthApplication;
import org.intelehealth.kf.appointmentNew.MyAppointmentActivity;
import org.intelehealth.kf.appointmentNew.ScheduleAppointmentActivity_New;
import org.intelehealth.kf.ayu.visit.VisitCreationActivity;
import org.intelehealth.kf.ayu.visit.common.VisitUtils;
import org.intelehealth.kf.ayu.visit.common.adapter.SummaryViewAdapter;
...
import org.intelehealth.kf.models.DocumentObject;
...
import org.intelehealth.kf.utilities.BitmapUtils;
    ...
    private boolean checkAndRequestPermissions(int id) {
        ...
        if (id == 1) {
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.S_V2) {
                int readMediaImagesPermission = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_MEDIA_IMAGES);
