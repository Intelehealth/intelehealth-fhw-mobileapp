package org.intelehealth.ekalhelpline.database;
...
public class InteleHealthDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void uuidInsert(SQLiteDatabase db) {
        ...
        if (sessionManager.isFirstTimeLaunched()) {
            ...
            db.execSQL("INSERT OR REPLACE INTO tbl_uuid_dictionary (uuid,name) VALUES('dfe138b6-1a75-46b6-81ce-136a229f3702','ATTRIBUTE_SECONDARY_PHONE_NUMBER')");
