package org.intelehealth.ekalhelpline.activities.visitSummaryActivity;
...
import org.intelehealth.ekalhelpline.activities.additionalDocumentsActivity.AdditionalDocumentsActivity;
import org.intelehealth.ekalhelpline.activities.complaintNodeActivity.ComplaintNodeActivity;
import org.intelehealth.ekalhelpline.activities.familyHistoryActivity.FamilyHistoryActivity;
import org.intelehealth.ekalhelpline.activities.pastMedicalHistoryActivity.PastMedicalHistoryActivity;
...
import org.intelehealth.ekalhelpline.database.dao.ProviderAttributeLIstDAO;
...
import org.intelehealth.ekalhelpline.models.ClsDoctorDetails;
import org.intelehealth.ekalhelpline.models.Patient;
import org.intelehealth.ekalhelpline.models.dto.ObsDTO;
import org.intelehealth.ekalhelpline.services.DownloadService;
...
//        mDoctorName.setVisibility(View.GONE);
        ...
        if (items != null) {
            ...
            if(!isVisitSpecialityExists)
                if(items.contains("Curiosity Resolution"))
...
//                    mTemp = "Temperature(F): " + temperature.getValue();
        ...
        if (objClsDoctorDetails.getSpecialization()!= null && !objClsDoctorDetails.getSpecialization().isEmpty() && objClsDoctorDetails.getSpecialization().equalsIgnoreCase("TLD Query"))
        {
            String htmlDocument =
                    String.format(font_face + "<b><p id=\"heading_1\" style=\"font-size:16pt; margin: 0px; padding: 0px; text-align: center;\">%s</p>" +
                                    "<p id=\"heading_2\" style=\"font-size:12pt; margin: 0px; padding: 0px; text-align: center;\">%s</p>" +
...
//adult intails display code
    ...
    ClsDoctorDetails objClsDoctorDetails = new ClsDoctorDetails();
