...
import org.intelehealth.ekalhelpline.activities.followuppatients.FollowUpPatientAdapter;
...
public class ClosedVisitsActivity extends AppCompatActivity {

    private static final String TAG = ClosedVisitsActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(getResources().getString(R.string.closed_visits_HomeScreen));
        ...
        context = ClosedVisitsActivity.this;
    ...
    private void firstQuery() {
        try {
            ...
            if(allPatients.size()>0) {
                closedAdapter = new ClosedAdapter(allPatients, ClosedVisitsActivity.this);
    ...
    private void displaySingleSelectionDialog() {
        ...
        dialogBuilder = new MaterialAlertDialogBuilder(ClosedVisitsActivity.this);
        ...
        dialogBuilder.setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(requiredPatients.size()>0) {
                    closedAdapter = new ClosedAdapter(requiredPatients, ClosedVisitsActivity.this);
                    no_records_found_textview.setVisibility(View.GONE);
                }
                else
                {
    ...
    private List<ActivePatientModel> doQueryWithProviders(List<String> providersUuids) {
        List<ActivePatientModel> todayPatientList = new ArrayList<>();
        String query = "SELECT distinct a.uuid, a.sync, a.patientuuid, a.startdate, a.enddate, b.uuid, b.first_name, b.middle_name, b.last_name, b.date_of_birth, b.openmrs_id, o.value AS obsvalue FROM tbl_visit a, tbl_patient b, tbl_encounter d, tbl_obs o WHERE b.uuid = a.patientuuid " +
                "AND a.enddate is NOT NULL AND a.uuid = d.visituuid AND d.uuid = o.encounteruuid  AND d.provider_uuid in ('" + StringUtils.convertUsingStringBuilder(providersUuids) + "') " +
                " AND o.conceptuuid = '36d207d6-bee7-4b3e-9196-7d053c6eddce'  " +
