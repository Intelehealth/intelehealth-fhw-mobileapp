...
public final class StringUtils {
    ...
    public static String extractArabicStateName(String val) {
        switch (val) {
            case "As-Sweida (السويداء)":
                val = "ٱلسُّوَيْدَاء";
                break;
    ...
    public static String extractEnglishStateName(String val) {
        switch (val) {
            case "As-Sweida (السويداء)":
                val = "As-Sweida";
                break;
    ...
    public static String extractArabicVillageName(String val) {
        switch (val) {
            case "Al-Shomarah (الشوماره)":
                val = "الشوماره";
                break;
            case "Ariqa (عريقة)":
                val = "عريقة";
            ...
            case "Dama (داما)":
                val = "داما";
                break;
            case "Deir Dama (دير داما)":
                val = "دير داما";
                break;
            case "Harran (Ariqa) (حران)":
                val = "حران";
                break;
            case "Jrein (جرين)":
                val = "جرين";
            ...
            case "Waqm (وقم)":
                val = "وقم";
                break;
            case "Ain Azzaman (مستوصف عين الزمان)":
                val = "مستوصف عين الزمان";
                break;
            case "Al- Thawrah - As-Sweida (ne) (حي الثورة-السويداء)":
                val = "حي الثورة-السويداء";
                break;
            case "Aslaha (اصلحة)":
                val = "اصلحة";
            ...
            case "Dara (دارة)":
                val = "دارة";
                break;
            case "Fursan (ne) (حي الفرسان-السويداء)":
                val = "حي الفرسان-السويداء";
                break;
            case "Habran (حبران)":
                val = "حبران";
                break;
            case "Hurriyeh - As-Sweida (ne) (حي الحرية-السويداء)":
                val = "حي الحرية-السويداء";
                break;
            case "Istiqlal (ne) (حي الاستقلال-السويداء)":
                val = "حي الاستقلال-السويداء";
                break;
            case "Jbib (جبيب)":
                val = "جبيب";
                break;
            case "Jihad (ne) (حي الجهاد-السويداء)":
                val = "حي الجهاد-السويداء";
                break;
            case "Joulan (ne) (حي الجولان-السويداء)":
                val = "حي الجولان-السويداء";
                break;
            case "Kafr (الكفر)":
                val = "الكفر";
                break;
            case "Kafr Ellahaf (كفر اللحف)":
                val = "كفر اللحف";
                break;
            case "Kanaker (As-Sweida) (كناكر)":
                val = "كناكر";
                break;
            case "Kherba (خربا)":
                val = "خربا";
            ...
            case "Mayamas (مياماس)":
                val = "مياماس";
                break;
            case "Mazra'a (ne) (حي المزرعة-السويداء)":
                val = "حي المزرعة-السويداء";
                break;
            case "Mjeimer (مجيمر)":
                val = "مجيمر";
                break;
            case "Nahda - As-Sweida (ne) (حي النهضة-السويداء)":
                val = "حي النهضة-السويداء";
                break;
            case "Ora (عرى)":
                val = "عرى";
            ...
            case "Qanawat (قنوات)":
                val = "قنوات";
                break;
            case "Raha (As-Sweida) (الرحى)":
                val = "الرحى";
                break;
            case "Rassas (رساس)":
                val = "رساس";
                break;
            case "Rima Hazem (ريمة حازم)":
                val = "ريمة حازم";
                break;
            case "Sahwet Balata (سهوة البلاطة)":
                val = "سهوة البلاطة";
                break;
            case "Sahwet Elkhodar (سهوة الخضر)":
                val = "سهوة الخضر";
                break;
            case "Sakaka (سكاكة)":
                val = "سكاكة";
                break;
            case "Salim (As-Sweida) (سليم)":
                val = "سليم";
                break;
            case "Shuhada - As-Sweida (ne) (حي الشهداء-السويداء)":
                val = "حي الشهداء-السويداء";
                break;
            case "Thaala (ثعلة)":
                val = "ثعلة";
            ...
            case "Walgha (ولغا)":
                val = "ولغا";
                break;
            case "Wihdeh - As-Sweida (ne) (حي الوحدة-السويداء)":
                val = "حي الوحدة-السويداء";
                break;
            case "Anz (Gharyeh) (عنز)":
                val = "عنز";
                break;
            case "Gharyeh (الغاريه)":
                val = "الغاريه";
                break;
            case "Kherbet Awad (خربة عواد)":
                val = "خربة عواد";
                break;
            case "Maghir (Gharyeh) (المغير)":
                val = "المغير";
                break;
            case "Big Sura (الصورة الكبيرة)":
                val = "الصورة الكبيرة";
                break;
            case "Haqf (الحقف)":
                val = "الحقف";
                break;
            case "Hazm (Little Sura) (حازم)":
                val = "حازم";
                break;
            case "Kalidiyeh (Little Sura) (الخالدية)":
                val = "الخالدية";
                break;
            case "Khalkhaleh (خلخلة)":
                val = "خلخلة";
                break;
            case "Kherbet Ghotha (خربة الغوثة)":
                val = "خربة الغوثة";
                break;
            case "Lahetheh (لاهثة)":
                val = "لاهثة";
                break;
            case "Little Sura (الصورة الصغيرة)":
                val = "الصورة الصغيرة";
                break;
            case "Nothern Ushayhib (شمال الشهيب)":
                val = "شمال الشهيب";
                break;
            case "Radimeh Ellewa (رضيمة اللوا)":
                val = "رضيمة اللوا";
                break;
            case "Salmiyeh (Little Sura) (سالميه (صورة الصغيرة))":
                val = "سالميه (صورة الصغيرة)";
                break;
            case "Seerat Alyah (سيرة العلي)":
                val = "سيرة العلي";
                break;
            case "Tal Asfar (تل الأصفر)":
                val = "تل الأصفر";
                break;
            case "Thakir (ذكير)":
                val = "ذكير";
                break;
            case "Um Hartein (Little Sura) (ام حارتين)":
                val = "ام حارتين";
                break;
            case "Bosan (بوسان)":
                val = "بوسان";
            ...
            case "Kassib (كسيب)":
                val = "كسيب";
                break;
            case "Khribet ad Diyath (خربة الضياث)":
                val = "خربة الضياث";
                break;
            case "Mashnaf (مشنف)":
                val = "مشنف";
                break;
            case "Ojeilat (العجيلات)":
                val = "العجيلات";
                break;
            case "Rami (Mashnaf) (رامي)":
                val = "رامي";
                break;
            case "Rashideh (رشيده)":
                val = "رشيده";
            ...
            case "Tarba (طربا)":
                val = "طربا";
                break;
            case "Tiba (Mashnaf) (الطيبة)":
                val = "الطيبة";
                break;
            case "Um Riwaq (ام رواق)":
                val = "ام رواق";
                break;
            case "Dor (دور)":
                val = "دور";
            ...
            case "Dweira (دويرة)":
                val = "دويرة";
                break;
            case "Jidya (Mazra'a) (جدية)":
                val = "جدية";
                break;
            case "Majdal 6 (مجدل)":
                val = "مجدل";
                break;
            case "Mazra'a - Sijn (المزرعة)":
                val = "المزرعة";
                break;
            case "Najran (نجران)":
                val = "نجران";
            ...
            case "Qarrasa (قراصة)":
                val = "قراصة";
                break;
            case "Rima Ellahf (ريمة إللحف)":
                val = "ريمة إللحف";
                break;
            case "Samie (سميع)":
                val = "سميع";
                break;
            case "Samma Al-Hneidat (صمة الهنيدات)":
                val = "صمة الهنيدات";
                break;
            case "Taara (تعارة)":
                val = "تعارة";
            ...
            case "Sheab (شعيب)":
                val = "شعيب";
                break;
            case "Tal Elloz (تل اللوز)":
                val = "تل اللوز";
                break;
            case "Tal Majdaa (تل مجدا)":
                val = "تل مجدا";
                break;
            case "Tleilin (طليلين)":
                val = "طليلين";
                break;
            case "Um Shama (أم شامة)":
                val = "أم شامة";
                break;
            case "Afineh (العفينة)":
                val = "العفينة";
            ...
            case "Karis (كاريس)":
                val = "كاريس";
                break;
            case "Mashquq (Salkhad) (مشقوق)":
                val = "مشقوق";
                break;
            case "Mneithreh (منيذرة)":
                val = "منيذرة";
                break;
            case "Os (عوس)":
                val = "عوس";
            ...
            case "Salkhad (صلخد)":
                val = "صلخد";
                break;
            case "Sama Elbardan (صمة البردان)":
                val = "صمة البردان";
                break;
            case "Shannireh (شنيرة)":
                val = "شنيرة";
                break;
            case "Tahula (تحولة)":
                val = "تحولة";
            ...
            case "Salakhed (صلاخد)":
                val = "صلاخد";
                break;
            case "Shahba (Shahba) (شهبا)":
                val = "شهبا";
                break;
            case "Sweimreh (سويمرة)":
                val = "سويمرة";
                break;
            case "Tima (تيما)":
                val = "تيما";
                break;
            case "Um Dbeib (ام ضبيب)":
                val = "ام ضبيب";
                break;
            case "Um Elzaytun (أم إلزايتون)":
                val = "أم إلزايتون";
                break;
            case "Araja (عراجة)":
                val = "عراجة";
                break;
            case "Banat Baeir (بنات باير)":
                val = "بنات باير";
                break;
            case "Barek (بارك)":
                val = "بارك";
                break;
            case "Bothaina (البثينة)":
                val = "البثينة";
                break;
            case "Duma (Shaqa) (دوما)":
                val = "دوما";
                break;
            case "Hayat (Shaqa) (الهيات)":
                val = "الهيات";
                break;
            case "Hit (Shaqa) (الهيت)":
                val = "الهيت";
                break;
            case "Jneineh (Shaqa) (جنينة)":
                val = "جنينة";
                break;
            case "Qasr (القصر)":
                val = "القصر";
            ...
            case "Thibeen (ذبين)":
                val = "ذبين";
                break;
            case "Um Elrumman (Thibeen) (ام الرمان)":
                val = "ام الرمان";
                break;
            case "Homs (حمص)":
                val = "حمص";
    ...
    public static String extractEnglishVillageName(String val) {
        switch (val) {
            case "Al-Shomarah (الشوماره)":
                val = "Al-Shomarah";
                break;
