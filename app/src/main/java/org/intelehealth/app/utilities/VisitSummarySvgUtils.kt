...
class VisitSummarySvgUtils {
    companion object {
        ...
        fun getVitalsSvg(): String {
            val accentColor =
                ContextCompat.getColor(IntelehealthApplication.getInstance(), R.color.colorAccent)
        ...
        @JvmStatic
        fun getCaseIcon(): String {
            val accentColor =
                ContextCompat.getColor(IntelehealthApplication.getInstance(), R.color.colorAccent)
            val accentColorHex = VisitSummaryPdfGenerator.intToHex(accentColor)
            val outerCircleAlpha = "${accentColorHex}33"
            return "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"60\" height=\"60\" viewBox=\"0 0 64 64\" id=\"vector\">" +
                    "    <path id=\"path\" d=\"M 32 0 L 32 0 C 40.484 0 48.629 3.374 54.627 9.373 C 60.626 15.371 64 23.516 64 32 L 64 32 C 64 40.484 60.626 48.629 54.627 54.627 C 48.629 60.626 40.484 64 32 64 L 32 64 C 23.516 64 15.371 60.626 9.373 54.627 C 3.374 48.629 0 40.484 0 32 L 0 32 C 0 23.516 3.374 15.371 9.373 9.373 C 15.371 3.374 23.516 0 32 0 Z\" fill=\"" + outerCircleAlpha + "\"/>" +
                    "    <path id=\"path_1\" d=\"M 38.708 21.207 L 25.291 21.207 C 24.324 21.207 23.541 21.99 23.541 22.957 L 23.541 41.04 C 23.541 42.007 24.324 42.79 25.291 42.79 L 38.708 42.79 C 39.674 42.79 40.458 42.007 40.458 41.04 L 40.458 22.957 C 40.458 21.99 39.674 21.207 38.708 21.207 Z\" fill=\"#00000000\" stroke=\"" + accentColorHex + "\" stroke-width=\"2\" stroke-linejoin=\"round\"/>" +
                    "    <path id=\"path_2\" d=\"M 37.398 34.043 L 34.482 34.043\" fill=\"#00000000\" stroke=\"" + accentColorHex + "\" stroke-width=\"2\" stroke-linecap=\"round\"/>" +
                    "    <path id=\"path_3\" d=\"M 37.398 29.957 L 34.482 29.957\" fill=\"#00000000\" stroke=\"" + accentColorHex + "\" stroke-width=\"2\" stroke-linecap=\"round\"/>\n" +
                    "    <path id=\"path_4\" d=\"M 37.398 25.875 L 34.482 25.875\" fill=\"#00000000\" stroke=\"" + accentColorHex + "\" stroke-width=\"2\" stroke-linecap=\"round\"/>\n" +
                    "    <path id=\"path_5\" d=\"M 37.398 38.125 L 34.482 38.125\" fill=\"#00000000\" stroke=\"" + accentColorHex + "\" stroke-width=\"2\" stroke-linecap=\"round\"/>\n" +
                    "    <path id=\"path_6\" d=\"M 30.977 25.875 L 30.977 38.125\" fill=\"#00000000\" stroke=\"" + accentColorHex + "\" stroke-width=\"2\" stroke-linecap=\"round\"/>\n" +
                    "    <path id=\"path_7\" d=\"M 27.477 26.75 C 26.993 26.75 26.602 26.358 26.602 25.875 C 26.602 25.392 26.993 25 27.477 25 C 27.96 25 28.352 25.392 28.352 25.875 C 28.352 26.358 27.96 26.75 27.477 26.75 Z\" fill=\"" + accentColorHex + "\"/>" +
                    "    <path id=\"path_8\" d=\"M 27.477 30.832 C 26.993 30.832 26.602 30.44 26.602 29.957 C 26.602 29.474 26.993 29.082 27.477 29.082 C 27.96 29.082 28.352 29.474 28.352 29.957 C 28.352 30.44 27.96 30.832 27.477 30.832 Z\" fill=\"" + accentColorHex + "\"/>\n" +
                    "    <path id=\"path_9\" d=\"M 27.477 34.918 C 26.993 34.918 26.602 34.526 26.602 34.043 C 26.602 33.56 26.993 33.168 27.477 33.168 C 27.96 33.168 28.352 33.56 28.352 34.043 C 28.352 34.526 27.96 34.918 27.477 34.918 Z\" fill=\"" + accentColorHex + "\"/>\n" +
                    "    <path id=\"path_10\" d=\"M 27.477 39 C 26.993 39 26.602 38.608 26.602 38.125 C 26.602 37.642 26.993 37.25 27.477 37.25 C 27.96 37.25 28.352 37.642 28.352 38.125 C 28.352 38.608 27.96 39 27.477 39 Z\" fill=\"" + accentColorHex + "\"/>\n" +
                    "</svg>"
        }
    }
}