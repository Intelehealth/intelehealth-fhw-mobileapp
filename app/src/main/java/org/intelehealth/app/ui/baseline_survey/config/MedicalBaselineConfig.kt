package org.intelehealth.app.ui.baseline_survey.config

import org.intelehealth.config.room.entity.PatientRegistrationFields

/**
 * Created by Shazzad H Kanon on 09-12-2024 - 11:00.
 * Email : shazzad@intelehealth.org
 * Mob   : +8801647040520
 **/
class MedicalBaselineConfig {
    var hbCheck: PatientRegistrationFields? = null
    var bpCheck: PatientRegistrationFields? = null
    var sugarCheck: PatientRegistrationFields? = null
    var bpValue: PatientRegistrationFields? = null
    ...
    var smokingFrequency: PatientRegistrationFields? = null
    var chewTobacco: PatientRegistrationFields? = null
    var alcoholHistory: PatientRegistrationFields? = null
