 ...
 * Mob   : +919727206702
 **/
public class NASVideoActivity extends CoreVideoCallActivity implements SwipeButton.SwipeEventListener {
    public static void startVideoCallActivity(Context context, RtcArgs args) {
        ...
        Intent intent = new Intent(context, NASVideoActivity.class);
...
//        binding.incomingCallView.fabAcceptCall.setOnClickListener(view -> acceptCall());
        binding.incomingCallView.fabDeclineCall.swipeEventListener = NASVideoActivity.this;
        binding.incomingCallView.fabAcceptCall.swipeEventListener = NASVideoActivity.this;
    }

    private void initView() {
        if (args != null && args.getDoctorName() != null) {
            String doctorName = args.getDoctorName();
            if (!args.getDoctorName().startsWith(getString(org.intelehealth.klivekit.R.string.doctor_annotation))) {
                doctorName = getString(org.intelehealth.klivekit.R.string.doctor_annotation) + doctorName;
            }
