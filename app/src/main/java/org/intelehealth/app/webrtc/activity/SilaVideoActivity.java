 ...
 * Mob   : +919727206702
 **/
public class SilaVideoActivity extends CoreVideoCallActivity implements SwipeButton.SwipeEventListener {
    public static void startVideoCallActivity(Context context, RtcArgs args) {
        ...
        Intent intent = new Intent(context, SilaVideoActivity.class);
...
//        binding.incomingCallView.fabAcceptCall.setOnClickListener(view -> acceptCall());
        binding.incomingCallView.fabDeclineCall.swipeEventListener = SilaVideoActivity.this;
        binding.incomingCallView.fabAcceptCall.swipeEventListener = SilaVideoActivity.this;
    }
