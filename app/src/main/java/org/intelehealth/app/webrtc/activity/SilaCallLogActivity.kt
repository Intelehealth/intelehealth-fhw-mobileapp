 ...
 * Mob   : +919727206702
 **/
class SilaCallLogActivity : CoreCallLogActivity(), BaseViewHolder.ViewHolderClickListener {
        ...
        binding.callLogContent.rvCallLogs.apply {
            ...
            addItemDecoration(
                DividerItemDecoration(
                    this@SilaCallLogActivity, DividerItemDecoration.VERTICAL
                )
            )
            this@SilaCallLogActivity.adapter.updateItems(logs.toMutableList())
            adapter = this@SilaCallLogActivity.adapter
        }
    }
    ...
    override fun setupActionBar() {
        ...
        binding.callLogAppBar.toolbar.setNavigationOnClickListener { finish() }
    }
    ...
    private fun startChatActivity(callLog: RtcCallLog) {
        ...
        SilaChatActivity.startChatActivity(this, args)
    }
}