 ...
 * Mob   : +919727206702
 **/
class NASCallLogActivity : CoreCallLogActivity(), BaseViewHolder.ViewHolderClickListener {
        ...
        binding.callLogContent.rvCallLogs.apply {
            ...
            addItemDecoration(
                DividerItemDecoration(
                    this@NASCallLogActivity, DividerItemDecoration.VERTICAL
                )
            )
            this@NASCallLogActivity.adapter.updateItems(logs.toMutableList())
            adapter = this@NASCallLogActivity.adapter
        }
    }
    ...
    private fun startChatActivity(callLog: RtcCallLog) {
        ...
        NASChatActivity.startChatActivity(this, args)
    }
}