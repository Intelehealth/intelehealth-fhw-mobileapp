 ...
 * Mob   : +919727206702
 **/
public class NASChatActivity extends ChatActivity {
    public static void startChatActivity(Context context, RtcArgs args) {
        Intent chatIntent = new Intent(context, NASChatActivity.class);
    ...
    protected void initiateView() {
        ...
        mLayoutManager = new LinearLayoutManager(NASChatActivity.this, LinearLayoutManager.VERTICAL, true);
