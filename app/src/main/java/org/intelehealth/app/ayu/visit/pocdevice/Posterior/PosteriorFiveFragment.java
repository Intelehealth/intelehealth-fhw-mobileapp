...
public class PosteriorFiveFragment extends Fragment implements RecorderListener {
    private FragmentPosteriorFiveBinding mBinding;
    ...
    public static PosteriorFiveFragment newInstance(boolean isEditMode,
                                              String patientName,
                                              String patientUuid,
                                              String visitUuid,
        ...
        PosteriorFiveFragment posteriorFiveFragment = new PosteriorFiveFragment();
        ...
        posteriorFiveFragment.setArguments(args);
        return posteriorFiveFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_posterior_five, container, false);
