...
public class AnteriorOneFragment extends Fragment implements RecorderListener {
    private FragmentAnteriorOneBinding mBinding;
    ...
    public static AnteriorOneFragment newInstance(
            boolean isEditMode,
            String patientName,
            String patientUuid,
            String visitUuid,
        ...
        AnteriorOneFragment anteriorOneFragment = new AnteriorOneFragment();
        Bundle args = new Bundle();
        args.putBoolean("isEditMode", isEditMode);
       // args.putSerializable("vitals", vitalsObject);
        ...
        anteriorOneFragment.setArguments(args);
        return anteriorOneFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_anterior_one, container, false);
    ...
    public void onWebhookResult(String result) {
        // 8. update DB
        db.updateResult(visitUuid, "", result);
