...
public class PosteriorThreeFragment extends Fragment implements RecorderListener {

    private FragmentPosteriorThreeBinding mBinding;
    ...
    public static PosteriorThreeFragment newInstance(boolean isEditMode,
                                              String patientName,
                                              String patientUuid,
                                              String visitUuid,
        ...
        PosteriorThreeFragment posteriorThreeFragment = new PosteriorThreeFragment();
        ...
        posteriorThreeFragment.setArguments(args);
        return posteriorThreeFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_posterior_three, container, false);
