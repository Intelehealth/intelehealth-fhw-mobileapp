package org.intelehealth.app.ayu.visit.pocdevice.Anterior;
...
import org.intelehealth.app.databinding.FragmentAnteriorOneBinding;
import org.intelehealth.app.databinding.FragmentAnteriorTwoBinding;
...
public class AnteriorTwoFragment extends Fragment implements RecorderListener {

    private FragmentAnteriorTwoBinding mBinding;
    ...
    public static AnteriorTwoFragment newInstance(boolean isEditMode,
                                                  String patientName,
                                                  String patientUuid,
                                                  String visitUuid,
        ...
        AnteriorTwoFragment anteriorTwoFragment = new AnteriorTwoFragment();
        ...
        anteriorTwoFragment.setArguments(args);
        return anteriorTwoFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_anterior_two, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CustomLog.v("AnteriorOneFragment", "Patient ID: " + patientUuid);
        CustomLog.v("AnteriorOneFragment", "Visit ID: " + visitUuid);
        CustomLog.v("AnteriorOneFragment", "Patient Name: " + patientName);
        CustomLog.v("AnteriorOneFragment", "Intent Tag: " + intentTag);
        CustomLog.v("AnteriorOneFragment", "Age: " + float_ageYear_Month);
        ...
        mBinding.btnStartRecording.setOnClickListener(v -> {
            ...
            AyuSynk.getBleInstance().setRecorderListener(this);   // FIRST
            AyuSynk.getBleInstance().setRecordingTimeLimit(24);  // limit
            AyuSynk.getBleInstance().setAyuVisualizerView(mBinding.waveView);

            AyuSynk.getBleInstance().startRecording();            // LAST
        ...
        mBinding.btnStopRecording.setOnClickListener(v -> {
            ...
            AyuSynk.getBleInstance().pauseRecording(); // optional
            mBinding.llSaveRecoding.setVisibility(View.VISIBLE);
      ...
      /*  mBinding.btnReRecordingOne.setOnClickListener(new View.OnClickListener() {
        ...
        mBinding.btnSaveRecording.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                db = new InteleHealthDatabaseHelper(getContext());
                // ✅ insert sample row
        ...
        mBinding.btnReCord.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // onWebhookResult("Normal heart sound");
            }
        });
