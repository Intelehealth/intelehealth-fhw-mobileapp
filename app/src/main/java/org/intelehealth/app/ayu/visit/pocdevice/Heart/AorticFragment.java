...
public class AorticFragment extends Fragment implements RecorderListener {
    ...
    public static AorticFragment newInstance(boolean isEditMode,
                                             String patientName,
                                             String patientUuid,
                                             String visitUuid,
        ...
        AorticFragment fragment = new AorticFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_aortic, container, false);
        ...
        mBinding.btnSaveRecordingMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              /*  Intent in = new Intent(getContext(), VisitSummaryActivity_New.class);
                ...
                in.putExtra(KEY_RECORDING_STATUS,recordingStatus);
    ...
    public void onWebhookResult(String result) {
        // 8. update DB
        db.updateResult(visitUuid, "aortic", result);
    ...
    // Removed local static uploadRecording to use UploadManager's implementation
}
