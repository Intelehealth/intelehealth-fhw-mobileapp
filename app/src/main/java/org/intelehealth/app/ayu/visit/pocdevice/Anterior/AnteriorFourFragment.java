...
public class AnteriorFourFragment extends Fragment implements RecorderListener {
    private FragmentAnteriorFourBinding mBinding;
    ...
    public static AnteriorFourFragment newInstance(boolean isEditMode,
                                             String patientName,
                                             String patientUuid,
                                             String visitUuid,
        ...
        AnteriorFourFragment anteriorFourFragment = new AnteriorFourFragment();
        ...
        anteriorFourFragment.setArguments(args);
        return anteriorFourFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_anterior_four, container, false);
