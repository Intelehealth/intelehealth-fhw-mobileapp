...
public class PosteriorOneFragment extends Fragment implements RecorderListener {
    private FragmentPosteriorOneBinding mBinding;
    ...
    public static PosteriorOneFragment newInstance(boolean isEditMode,
                                              String patientName,
                                              String patientUuid,
                                              String visitUuid,
        ...
        PosteriorOneFragment posteriorOneFragment = new PosteriorOneFragment();
        ...
        posteriorOneFragment.setArguments(args);
        return posteriorOneFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_posterior_one, container, false);
