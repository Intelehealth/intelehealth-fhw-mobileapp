...
public class LateralTwoFragment extends Fragment implements RecorderListener {
    private FragmentLateralTwoBinding mBinding;
    ...
    public static LateralTwoFragment newInstance(boolean isEditMode,
                                                 String patientName,
                                                 String patientUuid,
                                                 String visitUuid,
        ...
        LateralTwoFragment lateralTwoFragment = new LateralTwoFragment();
        ...
        lateralTwoFragment.setArguments(args);
        return lateralTwoFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_lateral_two, container, false);
