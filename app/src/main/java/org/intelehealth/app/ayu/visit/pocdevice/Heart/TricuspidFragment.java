...
import org.intelehealth.app.databinding.FragmentTricuspidBinding;
...
public class TricuspidFragment extends Fragment  implements RecorderListener {

    private FragmentTricuspidBinding mBinding;
    ...
    public static TricuspidFragment newInstance(boolean isEditMode,
                                             String patientName,
                                             String patientUuid,
                                             String visitUuid,
        ...
        TricuspidFragment tricuspidFragment = new TricuspidFragment();
        ...
        tricuspidFragment.setArguments(args);
        return tricuspidFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_tricuspid, container, false);
    ...
    public void onWebhookResult(String result) {
        // 8. update DB
        db.updateResult(visitUuid, "tricuspid", result);
