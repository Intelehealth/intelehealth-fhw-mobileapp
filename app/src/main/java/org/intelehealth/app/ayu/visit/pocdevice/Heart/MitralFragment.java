...
import org.intelehealth.app.databinding.FragmentMitralBinding;
...
public class MitralFragment extends Fragment implements RecorderListener {
    private FragmentMitralBinding mBinding;
    ...
    public static MitralFragment newInstance(boolean isEditMode,
                                             String patientName,
                                             String patientUuid,
                                             String visitUuid,
        ...
        MitralFragment mitralFragment= new MitralFragment();
        ...
        mitralFragment.setArguments(args);
        return mitralFragment;

    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_mitral, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            CustomLog.v("MitralFragment", "patientName: " + patientName);
            CustomLog.v("MitralFragment", "Patient ID: " + patientUuid);
            CustomLog.v("MitralFragment", "Visit ID: " + visitUuid);
            CustomLog.v("MitralFragment", "ENcounter UUID: " + encounterUuid);
            CustomLog.v("MitralFragment", "Intent Tag: " + intentTag);
            CustomLog.v("MitralFragment", "Age: " + float_ageYear_Month);
        }
        ...
        mBinding.btnSaveRecordingMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.insertRecord(
                        ...
                        "Normal");
                if (visitUuid == null) {
                    Toast.makeText(getContext(), "visitUuid is NULL", Toast.LENGTH_SHORT).show();
                    return;
                }
                /*VisitCreationActivity activity = (VisitCreationActivity) getActivity();
                if (activity != null && type != null) {
                    if ("heart".equalsIgnoreCase(type)) {
                        activity.setHeartRecorded(true);
                    } else if ("lung".equalsIgnoreCase(type)) {
                        activity.setLungRecorded(true);
                    }
                }*/
                /*Intent in = new Intent(getContext(), VisitSummaryActivity_New.class);
                in.putExtra("patientUuid", patientUuid);
                in.putExtra("visitUuid",visitUuid);
                in.putExtra("encounterUuidVitals",encounterUuid);
                in.putExtra("encounterUuidAdultIntial", "");
                in.putExtra("type", "heart");
                in.putExtra("position","aortic");
                in.putExtra("filePath",filePath);
                System.out.println("visitUuid" + visitUuid + "   "  + "   " + "   " + recordingStatus+ "  "+ "   " + "" + filePath);
                startActivity(in);*/
    ...
    public void recordingComplete(int status) {
        ...
        getActivity().runOnUiThread(() -> {
            ...
            if (audioShorts != null && audioShorts.length > 0) {
                ...
                if (getActivity() instanceof VisitCreationActivity) {
                   ...
                   // loadLungFragment();
                    ...
                    mActionListener.onFormSubmitted(
                            ...
                            false,
                            null);
                    Log.d("FLOW", "Heart Recorded = TRUE");
                }
    ...
    public void onWebhookResult(String result) {
        // 8. update DB
        db.updateResult(visitUuid, "mitral", result);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof VisitCreationActionListener) {
