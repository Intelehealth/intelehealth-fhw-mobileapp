...
public class FollowUpModel {
    ...
    public FollowUpModel(String uuid, String patientuuid, String openmrs_id, String first_name, String last_name, String date_of_birth, String phone_number, String visit_speciality, String followup_date, String sync, int referral) {
        this.uuid = uuid;
