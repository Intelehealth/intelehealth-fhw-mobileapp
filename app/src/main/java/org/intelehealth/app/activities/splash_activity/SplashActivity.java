...
//                TempDialog.show();
    ...
    private void showPermissionDeniedAlert(String[] permissions) {
        ...
        positiveButton.setTextColor(getResources().getColor(org.intelehealth.app.R.color.colorPrimary));
        //positiveButton.setTypeface(Typeface.DEFAULT, Typeface.BOLD);

        negativeButton.setTextColor(getResources().getColor(org.intelehealth.app.R.color.colorPrimary));
