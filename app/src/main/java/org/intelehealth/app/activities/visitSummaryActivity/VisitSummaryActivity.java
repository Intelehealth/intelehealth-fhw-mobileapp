...
import com.shivam.androidwebrtc.ChatActivity;
...
public class VisitSummaryActivity extends AppCompatActivity {
    ...
    public static final String FILTER = "io.intelehealth.app.activities.visit_summary_activity.REQUEST_PROCESSED";
...
//                            Toast.makeText(VisitSummaryActivity.this, getString(R.string.upload_completed), Toast.LENGTH_SHORT).show();
        ...
        if (bpText.equals("/")) {  //when new patient is being registered we get / for BP
            ...
            //when we setup org and get data from other users, we get null/null from server...
            bpView.setText("");
        } else {
