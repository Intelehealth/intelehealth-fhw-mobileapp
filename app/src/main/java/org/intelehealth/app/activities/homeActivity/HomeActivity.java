...
//                }
        ...
        showProgressbar();
        Logger.logV("FirebaseInstanceId", FirebaseInstanceId.getInstance().getToken());
        startActivity(new Intent(HomeActivity.this, IncomingVCallActivity.class));
    }
...
//                manageBackup(true, false);  // to backup org data at any time of the day
//                return true;
//
//            case R.id.restoreOption:
//                manageBackup(false, false); // to restore org data if db is empty
//                return true;
