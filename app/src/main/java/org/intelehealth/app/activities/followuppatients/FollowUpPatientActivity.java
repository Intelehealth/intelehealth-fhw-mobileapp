...
public class FollowUpPatientActivity extends AppCompatActivity {
    ...
    public List<FollowUpModel> getAllPatientsFromDB(int offset) {
        ...
        String query = "SELECT a.uuid, a.sync, a.patientuuid, a.startdate, a.enddate, b.uuid, b.first_name, b.middle_name, " +
                "b.last_name, b.date_of_birth, b.openmrs_id, c.value AS speciality, o.value, " +
                ...
                "o.value is NOT NULL GROUP BY a.patientuuid Order By proper_date desc";
