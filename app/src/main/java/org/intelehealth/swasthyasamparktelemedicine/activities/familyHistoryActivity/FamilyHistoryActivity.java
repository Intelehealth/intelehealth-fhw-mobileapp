package org.intelehealth.swasthyasamparktelemedicine.activities.familyHistoryActivity;
...
import org.intelehealth.swasthyasamparktelemedicine.activities.questionNodeActivity.QuestionsAdapter;
...
import org.intelehealth.swasthyasamparktelemedicine.utilities.pageindicator.ScrollingPagerIndicator;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(org.intelehealth.swasthyasamparktelemedicine.utilities.StringUtils.getValue(value));
