...
public class PlansByHealthWorkerAdapter extends StageHeaderAdapter {
    ...
    public PlansByHealthWorkerAdapter(@NonNull Context ctx, @NonNull LinkedList<ItemHeader> lists) {
        super(ctx, lists);
    }
