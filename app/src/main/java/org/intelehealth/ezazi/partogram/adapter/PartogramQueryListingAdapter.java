...
public class PartogramQueryListingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class GenericViewHolder extends RecyclerView.ViewHolder {
        ...
        GenericViewHolder(View itemView) {
            super(itemView);
            tvSectionNameTextView = itemView.findViewById(R.id.tvSectionName_partogramlistSc);
            containerLinearLayout = itemView.findViewById(R.id.llContainer_partogramlistSc);
        }
    ...
    private void showAutoComplete_EditText(final View tempView, final int position, final int positionChild, final String paramDateType) {
        ...
        Log.d("showAutoComplete_Desc",dataEditText.getContentDescription().toString());
