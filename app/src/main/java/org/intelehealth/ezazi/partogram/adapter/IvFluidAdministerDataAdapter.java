...
public class IvFluidAdministerDataAdapter extends CategoryHeaderAdapter {
    ...
    public IvFluidAdministerDataAdapter(@NonNull Context ctx, @NonNull LinkedList<ItemHeader> lists) {
        super(ctx, lists);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RowItemIvFluidOxytocinAdministerBinding binding = RowItemIvFluidOxytocinAdministerBinding.inflate(getInflater(), parent, false);
        return new IVFluidAdministerViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof IVFluidAdministerViewHolder ivFluidAdministerViewHolder) {
            ivFluidAdministerViewHolder.setViewClickListener(clickListener);
            ivFluidAdministerViewHolder.setAccessMode(accessMode);
            ivFluidAdministerViewHolder.bind((Medication) getItem(position));
