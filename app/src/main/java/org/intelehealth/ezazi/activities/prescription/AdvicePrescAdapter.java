...
/**
 * Created by Prajwal Maruti Waingankar on 20-01-2022, 17:00
 * Copyright (c) 2021 . All rights reserved.
 * Email: prajwalwaingankar@gmail.com
 * Github: prajwalmw
 */

public class AdvicePrescAdapter extends RecyclerView.Adapter<AdvicePrescAdapter.PrescViewModel> {
    Context context;
    List<PrescDataModel> prescDataModels;
    SessionManager sessionManager;
    Base64Utils base64Utils = new Base64Utils();

    public AdvicePrescAdapter(Context context, List<PrescDataModel> prescDataModels) {
        this.context = context;
        this.prescDataModels = prescDataModels;
        sessionManager = new SessionManager(this.context);
    }

    public AdvicePrescAdapter(Context presContext) {
