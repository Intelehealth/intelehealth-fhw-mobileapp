...
import org.intelehealth.ezazi.appointment.ScheduleListingActivity;
import org.intelehealth.ezazi.appointment.api.ApiClientAppointment;
import org.intelehealth.ezazi.appointment.dao.AppointmentDAO;
import org.intelehealth.ezazi.appointment.model.AppointmentDetailsResponse;
import org.intelehealth.ezazi.appointment.model.CancelRequest;
import org.intelehealth.ezazi.appointment.model.CancelResponse;
import org.intelehealth.ezazi.activities.prescription.PrescriptionActivity;
import org.intelehealth.ezazi.models.prescriptionUpload.EncounterProvider;
...
import org.intelehealth.ezazi.activities.additionalDocumentsActivity.AdditionalDocumentsActivity;
import org.intelehealth.ezazi.activities.complaintNodeActivity.ComplaintNodeActivity;
import org.intelehealth.ezazi.activities.familyHistoryActivity.FamilyHistoryActivity;
import org.intelehealth.ezazi.activities.homeActivity.HomeActivity;
import org.intelehealth.ezazi.activities.pastMedicalHistoryActivity.PastMedicalHistoryActivity;
import org.intelehealth.ezazi.activities.physcialExamActivity.PhysicalExamActivity;
import org.intelehealth.ezazi.activities.vitalActivity.VitalsActivity;
...
import org.intelehealth.ezazi.database.dao.ProviderAttributeLIstDAO;
                    ...
                    try {
                        if (!isVisitSpecialityExists) {
                            isUpdateVisitDone = speciality_attributes
                                    .insertVisitAttributes(visitUuid, speciality_selected, VISIT_DR_SPECIALITY);
                        }
                        ...
                        if (mAppointmentDetailsResponse.getData() == null) {
                            ...
                            try {
                                ...
                                mInfoAppointmentBookingTextView.setText(getString(R.string.appointment_booked) + ":\n\n" +
                                        org.intelehealth.ezazi.utilities.StringUtils.getTranslatedDays(mAppointmentDetailsResponse.getData().getSlotDay(), new SessionManager(VisitSummaryActivity.this).getAppLanguage()) + "\n" +
