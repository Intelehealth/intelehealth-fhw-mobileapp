 ...
 * Mob   : +919727206702
 **/
public class ThemeTimePickerDialogBackup extends BaseDialogFragment<Void> implements TimePicker.OnTimeChangedListener {
    ...
    View getContentView() {
        ...
        timePickerBinding.clTimerView.setVisibility(View.GONE);
        setupCurrentTime();
        setClickListener();
...
//            header.setVisibility(View.GONE);
            int width = getResources().getDimensionPixelOffset(R.dimen.timepicker_header_width);
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(width, LinearLayout.LayoutParams.WRAP_CONTENT);
            params.gravity = Gravity.CENTER_HORIZONTAL;
            params.bottomMargin = getResources().getDimensionPixelOffset(R.dimen.actionbar_vertical_padding);
...
//    }
    ...
    public static class Builder extends BaseBuilder<Void, ThemeTimePickerDialogBackup> {
        ...
        @Override
        public ThemeTimePickerDialogBackup build() {
            ThemeTimePickerDialogBackup fragment = new ThemeTimePickerDialogBackup();
