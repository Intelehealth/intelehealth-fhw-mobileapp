...
public class VideoCallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_video_call_ezazi);
        ...
        setupActionBar();
        binding.incomingCallView.callerNameTv.setText(mDoctorName);
        binding.incomingCallView.inCallAcceptImv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.incomingCallView.inCallRejectImv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (socket != null) {
        ...
        binding.videoCallView.callActionView.btnMicOnOff.setActivated(true);
        binding.videoCallView.callActionView.btnMicOnOff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                        Toast.makeText(VideoCallActivity.this, getString(org.intelehealth.apprtc.R.string.audio_on_lbl), Toast.LENGTH_SHORT).show();
//                    } else {
//                        binding.audioImv.setImageResource(org.intelehealth.apprtc.R.drawable.ic_baseline_mic_off_24);
//                        Toast.makeText(VideoCallActivity.this, getString(org.intelehealth.apprtc.R.string.audio_off_lbl), Toast.LENGTH_SHORT).show();
//                    }
                }
            }
        });
        binding.videoCallView.callActionView.btnCallEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (socket != null)
                    socket.emit("bye");
        ...
        binding.videoCallView.callActionView.btnVideoOnOff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                    } else {
//                        binding.videoImv.setImageResource(org.intelehealth.apprtc.R.drawable.ic_baseline_videocam_off_24);
//                        Toast.makeText(CompleteActivity.this, getString(org.intelehealth.apprtc.R.string.video_off_lbl), Toast.LENGTH_SHORT).show();
//                    }
                }
            }
        });
        binding.videoCallView.callActionView.btnFlipCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//            binding.callingLayout.setVisibility(View.GONE);
    ...
    private void setupActionBar() {
        ...
        setTitle(mIsInComingRequest ? "Incoming Call" : "Ongoing Call");
...
//        negativeButton.setTextColor(getResources().getColor(org.intelehealth.apprtc.R.color.colorPrimary));
    ...
    private void initializeSurfaceViews() {
        ...
        binding.videoCallView.selfSurfaceView.init(rootEglBase.getEglBaseContext(), null);
        binding.videoCallView.selfSurfaceView.setEnableHardwareScaler(true);
        binding.videoCallView.selfSurfaceView.setMirror(true);

        binding.videoCallView.incomingSurfaceView.init(rootEglBase.getEglBaseContext(), null);
        binding.videoCallView.incomingSurfaceView.setEnableHardwareScaler(true);
        binding.videoCallView.incomingSurfaceView.setMirror(true);
    ...
    private void createVideoTrackFromCameraAndShowIt() {
        ...
        selfSurfaceViewVideoRenderer = new VideoRenderer(binding.videoCallView.selfSurfaceView);
    ...
    private PeerConnection createPeerConnection(PeerConnectionFactory factory) {
        ...
        PeerConnection.Observer pcObserver = new PeerConnection.Observer() {
            ...
            public void onAddStream(MediaStream mediaStream) {
                ...
                incomingSurfaceViewVideoRenderer = new VideoRenderer(binding.videoCallView.incomingSurfaceView);
