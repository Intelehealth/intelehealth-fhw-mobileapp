...
public class PatientsFrameJson {
    ...
    public void getPushRequestData(OnSuccessListener<PushRequestApiCall> listener) {
        new TaskExecutor<PushRequestApiCall>().executeTask(new TaskCompleteListener<PushRequestApiCall>() {
            @Override
            public PushRequestApiCall call() throws Exception {
            ...
            @Override
            public void onComplete(PushRequestApiCall result) {
