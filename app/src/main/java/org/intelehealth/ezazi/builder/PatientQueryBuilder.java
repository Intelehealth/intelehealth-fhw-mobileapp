...
//        SELECT P.uuid, P.openmrs_id, P.first_name, P.last_name, P.middle_name, P.date_of_birth, PA.value as bedNo,
//        (SELECT CASE
//        WHEN E.encounter_type_uuid = 'bd1fbfaa-f5fb-4ebd-b75c-564506fc309e' THEN
//                (SELECT O.value FROM tbl_obs O WHERE O.encounteruuid = E.uuid AND O.conceptuuid IN  ('23601d71-50e6-483f-968d-aeef3031346d', '9414cc17-1f97-4a27-8066-17591c11e513'))
...
//        WHERE E.visituuid =V.uuid  and E.voided = '0'  and U.uuid = E.encounter_type_uuid  OR E.encounter_type_uuid = 'bd1fbfaa-f5fb-4ebd-b75c-564506fc309e' ORDER BY U.name DESC LIMIT 1)  as stage,
