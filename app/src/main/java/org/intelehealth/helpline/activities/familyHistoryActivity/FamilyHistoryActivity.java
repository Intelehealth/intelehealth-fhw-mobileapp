package org.intelehealth.helpline.activities.familyHistoryActivity;
...
import org.intelehealth.helpline.activities.questionNodeActivity.QuestionsAdapter;
...
import org.intelehealth.helpline.utilities.pageindicator.ScrollingPagerIndicator;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(org.intelehealth.helpline.utilities.StringUtils.getValue(value));
