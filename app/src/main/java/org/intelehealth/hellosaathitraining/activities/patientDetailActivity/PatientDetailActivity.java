package org.intelehealth.hellosaathitraining.activities.patientDetailActivity;
...
import org.intelehealth.hellosaathitraining.activities.medicaladvice.MedicalAdviceExistingPatientsActivity;
...
import org.intelehealth.hellosaathitraining.database.InteleHealthDatabaseHelper;
...
import org.intelehealth.hellosaathitraining.models.FamilyMemberRes;
...
import org.intelehealth.hellosaathitraining.utilities.DownloadFilesUtils;
...
import org.intelehealth.hellosaathitraining.activities.visitSummaryActivity.VisitSummaryActivity;
...
//        updateSubscriptionUI(chb_subscription.isChecked());
        ...
        spinner_pref_bucket.setAdapter(bucketAdapter);
        spinner_pref_bucket.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0)
                    return;
...
//                                                break;
        ...
        btnSubscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedSubscriptionTime == null) {
