package org.intelehealth.hellosaathitraining.activities.identificationActivity;
...
import org.intelehealth.hellosaathitraining.activities.privacyNoticeActivity.PrivacyNotice_Activity;
import org.intelehealth.hellosaathitraining.database.dao.EncounterDAO;
import org.intelehealth.hellosaathitraining.database.dao.ObsDAO;
import org.intelehealth.hellosaathitraining.database.dao.VisitAttributeListDAO;
import org.intelehealth.hellosaathitraining.database.dao.VisitsDAO;
import org.intelehealth.hellosaathitraining.knowledgeEngine.Node;
import org.intelehealth.hellosaathitraining.models.dto.EncounterDTO;
import org.intelehealth.hellosaathitraining.models.dto.ObsDTO;
import org.intelehealth.hellosaathitraining.models.dto.VisitDTO;
import org.intelehealth.hellosaathitraining.syncModule.SyncUtils;
import org.intelehealth.hellosaathitraining.utilities.UuidDictionary;
...
import org.intelehealth.hellosaathitraining.database.dao.ImagesDAO;
import org.intelehealth.hellosaathitraining.database.dao.ImagesPushDAO;
import org.intelehealth.hellosaathitraining.database.dao.PatientsDAO;
import org.intelehealth.hellosaathitraining.database.dao.SyncDAO;
import org.intelehealth.hellosaathitraining.models.Patient;
import org.intelehealth.hellosaathitraining.models.dto.PatientAttributesDTO;
...
import org.intelehealth.hellosaathitraining.utilities.EditTextUtils;
import org.intelehealth.hellosaathitraining.utilities.FileUtils;
import org.intelehealth.hellosaathitraining.utilities.IReturnValues;
...
import org.intelehealth.hellosaathitraining.utilities.UuidGenerator;

import org.intelehealth.hellosaathitraining.activities.cameraActivity.CameraActivity;
import org.intelehealth.hellosaathitraining.activities.homeActivity.HomeActivity;
import org.intelehealth.hellosaathitraining.activities.setupActivity.SetupActivity;
import org.intelehealth.hellosaathitraining.utilities.NetworkConnection;
import org.intelehealth.hellosaathitraining.utilities.StringUtils;
...
//    Spinner mState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddPhoneNum = findViewById(R.id.identification_secondary_phone_number);
...
//        mState = findViewById(R.id.spinner_state);
        ...
        mGenderOther = findViewById(R.id.identification_gender_other);
...
//            added the catch exception to check the config and throwing back to setup activity
  ...
  /*      if(patient1.getDate_of_birth() != null) {
        ...
        mAddPhoneNum.setText(patient1.getSecondary_phone_number());
        ...
        autocompleteDistrict.setText(patient1.getAddress1());
...
//        mCaste.setAdapter(casteAdapter);
        ...
        try { //Helpline Referral adapter setting...
            String helplineInfoLanguage = "helpline_knowledge_" + sessionManager.getAppLanguage();
            int helplineInfos = res.getIdentifier(helplineInfoLanguage, "array", getApplicationContext().getPackageName());
            if (helplineInfos != 0) {
            ...
            helplineInfoSpinner.setAdapter(helplineKnowledgeAdapter);
        }
        catch (Exception e) {
            Logger.logE("Identification", "#648", e);
        }
...
*/
        ...
        if (patientID_edit != null) {
            ...
            if (patient1.getGender().equals("M")) {
                ...
                if (mGenderOther.isChecked())
                    mGenderOther.setChecked(false);
                Log.v(TAG, "yes");
            ...
            else if (patient1.getGender().equals("Other")) {
        ...
        if (patientID_edit != null) {
            ...
            } else
            {
                ...
                {
                    helplineInfoSpinner.setSelection(helplineKnowledgeAdapter.getPosition("Other"));
                    otherHelplineInfoET.setText(patient1.getCaste());
                }
                else {
...
//        mState.setAdapter(stateAdapter);
        ...
        helplineInfoSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    otherHelplineInfoET.setText("");
                    otherHelplineInfoET.setVisibility(View.GONE);
                }
            }
...
//            }
            ...
            if (!mGenderF.isChecked() && !mGenderM.isChecked() && !mGenderOther.isChecked()) {
                MaterialAlertDialogBuilder alertDialogBuilder = new MaterialAlertDialogBuilder(IdentificationActivity.this);
                alertDialogBuilder.setTitle(R.string.error);
                alertDialogBuilder.setMessage(R.string.identification_screen_dialog_error_gender);
                alertDialogBuilder.setPositiveButton(R.string.generic_ok, new DialogInterface.OnClickListener() {
        ...
        if(helplineInfoSpinner.getSelectedItem().toString().equalsIgnoreCase("Other") || helplineInfoSpinner.getSelectedItem().toString().equalsIgnoreCase("अन्य") || helplineInfoSpinner.getSelectedItem().toString().equalsIgnoreCase("इतर"))
        {
            ...
            {
                otherHelplineInfoET.setError(getString(R.string.error_field_required));
                focusView = otherHelplineInfoET;
                cancel = true;
                return;
            } else {
        ...
        if (numberRelationSpinner.getSelectedItemPosition() == 0) {
            TextView errorText = (TextView)numberRelationSpinner.getSelectedView();
            errorText.setError("");
            errorText.setTextColor(Color.RED);//just to highlight that this is an error
            errorText.setText(getString(R.string.error_field_required));//changes the selected item text to this
            focusView = numberRelationSpinner;
            cancel = true;
            return;
        }
