package org.intelehealth.hellosaathitraining.activities.visitSummaryActivity;
...
import org.intelehealth.hellosaathitraining.activities.additionalDocumentsActivity.AdditionalDocumentsActivity;
import org.intelehealth.hellosaathitraining.activities.complaintNodeActivity.ComplaintNodeActivity;
import org.intelehealth.hellosaathitraining.activities.familyHistoryActivity.FamilyHistoryActivity;
import org.intelehealth.hellosaathitraining.activities.pastMedicalHistoryActivity.PastMedicalHistoryActivity;
import org.intelehealth.hellosaathitraining.activities.patientSurveyActivity.PatientSurveyActivity;
...
import org.intelehealth.hellosaathitraining.database.dao.ProviderAttributeLIstDAO;
...
import org.intelehealth.hellosaathitraining.models.ClsDoctorDetails;
import org.intelehealth.hellosaathitraining.models.Patient;
import org.intelehealth.hellosaathitraining.models.dto.ObsDTO;
import org.intelehealth.hellosaathitraining.services.DownloadService;
...
import org.intelehealth.hellosaathitraining.activities.physcialExamActivity.PhysicalExamActivity;
...
//                    mTemp = "Temperature(F): " + temperature.getValue();
        ...
        if (objClsDoctorDetails.getSpecialization().equalsIgnoreCase("TLD Query"))
        {
            String htmlDocument =
                    String.format(font_face + "<b><p id=\"heading_1\" style=\"font-size:16pt; margin: 0px; padding: 0px; text-align: center;\">%s</p>" +
                                    "<p id=\"heading_2\" style=\"font-size:12pt; margin: 0px; padding: 0px; text-align: center;\">%s</p>" +
...
//       int i =  webView.getContentHeight();
    ...
    public void queryData(String dataString) {
        ...
        String[] columnsToReturn = {"openmrs_id", "first_name", "middle_name", "last_name",
                ...
                "postal_code", "phone_number","secondary_phone_number","preferred_language", "gender", "sdw", "occupation", "patient_photo"};
        final Cursor idCursor = db.query(table, columnsToReturn, patientSelection, patientArgs, null, null, null);
        ...
        if (idCursor.moveToFirst()) {
            do {
                ...
                patient.setPreferred_language(idCursor.getString(idCursor.getColumnIndexOrThrow("preferred_language")));
        ...
        if (idCursor1.moveToFirst()) {
            do {
                ...
                if (name.equalsIgnoreCase("Preferred Language")) {
                    patient.setPreferred_language(idCursor1.getString(idCursor1.getColumnIndexOrThrow("value")));
                }
