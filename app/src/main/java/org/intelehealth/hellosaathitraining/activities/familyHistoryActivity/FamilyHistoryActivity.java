package org.intelehealth.hellosaathitraining.activities.familyHistoryActivity;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(org.intelehealth.hellosaathitraining.utilities.StringUtils.getValue(value));
