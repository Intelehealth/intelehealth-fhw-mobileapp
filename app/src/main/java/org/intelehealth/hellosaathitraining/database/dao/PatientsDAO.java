package org.intelehealth.hellosaathitraining.database.dao;
...
import org.intelehealth.hellosaathitraining.services.MyIntentService;
...
import org.intelehealth.hellosaathitraining.models.dto.PatientAttributeTypeMasterDTO;
...
import org.intelehealth.hellosaathitraining.models.pushRequestApiCall.Attribute;
...
public class PatientsDAO {
    ...
    public boolean createPatients(PatientDTO patient, SQLiteDatabase db) throws DAOException {
        ...
        try {
            ...
            values.put("preferred_language", patient.getPreferredlanguage());
    ...
    public boolean insertPatientToDB(PatientDTO patientDTO, String uuid) throws DAOException {
        ...
        try {
            ...
            values.put("preferred_language", patientDTO.getPreferredlanguage());
    ...
    public boolean updatePatientToDB(Patient patientDTO, String uuid, List<PatientAttributesDTO> patientAttributesDTOS) throws DAOException {
        ...
        try {
            ...
            values.put("preferred_language", patientDTO.getPreferred_language());
            values.put("address1", patientDTO.getAddress1());
            values.put("address2", patientDTO.getAddress2());
            values.put("country", patientDTO.getCountry());
...
//                  middle_name = cursor.getString(cursor.getColumnIndexOrThrow("middle_name"));
        ...
        try {
            ...
            if (idCursor.getCount() != 0) {
                while (idCursor.moveToNext()) {
                    ...
                    patientDTO.setPreferredlanguage(idCursor.getString(idCursor.getColumnIndexOrThrow("preferred_language")));
     ...
     */
    public boolean insertPatient_Attribute_ReasonForCall(String patientUuid, String value, String attribute_Type_Uuid) throws DAOException {
        ...
        List<Attribute> attributeList = getPatientAttributes_Reason_for_Call(patientUuid, getUuidForAttribute(attribute_Type_Uuid));
        if(attributeList.size() != 0) {
            for (int i = 0; i < attributeList.size(); i++) {
                String attribute_data = attributeList.get(i).getValue();
                data = attribute_data + "," + value;
                Log.v("main", "data_length: "+ data.length());
            }
        }
        ...
        try {
            ...
            values.put("person_attribute_type_uuid", getUuidForAttribute(attribute_Type_Uuid));
...
/*
    public boolean insertPatient_Attribute_IVR_CALL_RESPONSE(String patientUuid, String value) throws DAOException {
        boolean isInserted = false;
        ...
        try {
            values.put("uuid", UUID.randomUUID().toString());
            values.put("person_attribute_type_uuid", getUuidForAttribute("Outgoing call"));
            values.put("patientuuid", patientUuid);
