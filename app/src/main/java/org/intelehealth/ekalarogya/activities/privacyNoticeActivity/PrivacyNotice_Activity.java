package org.intelehealth.ekalarogya.activities.privacyNoticeActivity;
...
//            } else
            if (current.toString().equals("or")) {
                ...
                String privacy_string = obj.getString("privacyNoticeText_Gujrati");
                if (privacy_string.isEmpty()) {
                    privacy_string = obj.getString("privacyNoticeText");
                    privacy_textview.setText(privacy_string);
                } else {
            ...
            } else if (current.toString().equals("kn")) {
