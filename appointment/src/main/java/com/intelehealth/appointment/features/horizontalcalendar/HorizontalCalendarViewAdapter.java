...
//        makeTodaysDateSelected(calendarModel, holder, currentMonth);
    ...
    private void makeTodaysDateSelected(CalendarModel calendarModel, MyViewHolder holder, int currentMonth) {
...
//            holder.tvDay.setTextColor(ContextCompat.getColor(context,R.color.colorPrimary));
    ...
    public void changeToSelect(int selectedPos, int position, MyViewHolder holder) {
